...
export const DEFAULT_PAYMOB_ENDPOINTS = {
  ...
  SUBSCRIPTIONS: {
    ...
    SUSPEND:
      "/api/acceptance/subscription-plans/SUBSCRIPTION_ID_PLACEHOLDER/suspend",
    ...
    LIST_CARDS:
      "/api/acceptance/subscriptions/SUBSCRIPTION_ID_PLACEHOLDER/card-tokens",
    CHANGE_PRIMARY_CARD:
    ...
    LIST_SUBSCRIPTION_DETAILS:
      "/api/acceptance/subscriptions/SUBSCRIPTION_ID_PLACEHOLDER",
    ...
    REGISTER_WEBHOOK:
      "/api/acceptance/subscriptions/SUBSCRIPTION_ID_PLACEHOLDER/webhooks",
    PLANS: {
      CREATE: "/api/acceptance/subscription-plans",
      SUSPEND:
        "/api/acceptance/subscription-plans/SUBSCRIPTION_PLAN_ID_PLACEHOLDER/suspend",
      RESUME:
        "/api/acceptance/subscription-plans/SUBSCRIPTION_PLAN_ID_PLACEHOLDER/resume",
      UPDATE:
        "/api/acceptance/subscription-plans/SUBSCRIPTION_PLAN_ID_PLACEHOLDER",
